# *Danio rerio* Genome Visualization

This project visualizes genomic data from *Danio rerio* using IGV(Integrative Genomics Viewer). IGV  is a bioinformatics tool used to visually explore the large genomic datasets. 
